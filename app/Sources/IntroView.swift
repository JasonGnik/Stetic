...
struct IntroView: View {
    ...
    private let slides: [Slide] = [
        ...
        .init(beat: .score("intro_score"), title: "Your physique, analyzed.",
              sub: "Upload one photo — we find what's holding your physique back and rank you 1 to 10."),
        .init(beat: .shot("intro_plan"), title: "A plan built on your weak points.",
              sub: "We prioritize your weak points — the exact split and exercise selection to bring them up."),
        .init(beat: .demo(video: "intro_log", poster: "intro_session"), title: "Improve every session.",
              sub: "Log your lifts. Stetic tells you when you beat last week and when to add weight — progressive overload, guided."),
